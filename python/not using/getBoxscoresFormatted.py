...
skaters_columns = [
    "Rk", "Season", "Game", "GameID", "Date", "Player", "PlayerID", "Team", "TeamName", "Is_Home", "Opp", "OppName", "G", "A", "PTS", "SOG", "TOI", "PIM", "EVG", "PPG", "SHG", "EVA", "PPA", "SHA"
]
...
if skaters_data and adv_skaters_data:
    ...
    merged_columns = [
        "Rk", "Season", "Game", "GameID", "Date", "Player", "PlayerID", "Team", "TeamName", "Is_Home", "Opp", "OppName", "G", "A", "PTS", "SOG", "HIT", "BLK", "TOI", "PIM", "EVG", "PPG", "SHG", "EVA", "PPA", "SHA", "SAT‑F"
    ]
