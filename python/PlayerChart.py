...
for filename in os.listdir(html_dir):
    if filename.endswith(".html"):
        ...
        unique_teams = player_gamelogs['Opp'].unique()
        ...
        stat_options = "\n".join([f'<option value="{stat}">{stat}</option>' for stat in all_stats])
        ...
        player_table.insert_before(chart_soup)  # Insert the chart before the table
