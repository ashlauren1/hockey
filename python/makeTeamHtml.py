...
# Load the CSV file
file_path = r"C:\Users\ashle\Documents\Projects\hockey\data\teamgamelogs.csv"
...
for team_id, team_data in grouped_data:
    ...
    team_name = team_data.iloc[0]['Team']  # Assuming 'Player' column holds the name
    
    # File name based on PlayerID
    team_filename = f'{output_dir}/{team_id}.html'
    ...
    for _, row in team_data.iterrows():
        html_content += f'''
            <tr>
                ...
                <td><a href="/teams/{row['TeamID']}.html" target="_blank">{row['TeamID']}</a></td>
