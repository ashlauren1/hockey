...
<div class="chartContainer">
    ...
    <div class="filter-buttons">
        ...
        <button onclick="filterGames('{stat}', '{game_id}', '{betting_line_id}', 10)" class="last_n_games_btn">L10</button>
        <button onclick="filterGames('{stat}', '{game_id}', '{betting_line_id}', 20)" class="last_n_games_btn">L20</button>
    ...
    <div class="slider-container">
        <div id="line-slider">
            ...
            <input type="range" id="{stat}_{game_id}_{betting_line_id}_lineSlider" min="0" max="30" step="0.25" value="{betting_line}" oninput="updateLine('{stat}', '{game_id}', '{betting_line_id}', this.value)" class="lineSliderInput">
